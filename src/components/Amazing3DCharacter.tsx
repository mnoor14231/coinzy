  ...
  return (
    <div className="relative flex items-center justify-center">
      <div className={`${getSizeClass(size)} relative`}>
        ...
        <div className={`w-full h-full relative rounded-full bg-gradient-to-br ${colors.bg} shadow-2xl ${colors.shadow} border-4 border-white/60 overflow-hidden transform-gpu`}
             style={{
