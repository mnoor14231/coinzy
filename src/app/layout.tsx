...
export const metadata: Metadata = {
  title: "🪙 كوينزي - تطبيق تعليم المال للأطفال",
  description: "تطبيق تفاعلي لتعليم الأطفال المهارات المالية بطريقة ممتعة ومشوقة",
  keywords: "تعليم, مال, أطفال, ادخار, تطبيق تفاعلي",
